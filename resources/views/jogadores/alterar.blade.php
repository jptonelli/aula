  ...
  <div class="site-wrap">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Alteração de Cadastro de Jogadores
        </div>
        <div class="card-body">
            <form method="POST" action="/jogadores/upd">
                @csrf <!-- TOKEN PARA SEGURANÇA -->
                <input type="hidden" name="id" id="id" value="{{$jogador->id}}">
                <div class="modal-body">
                    <label class="form-label" for="jogador_nome">Nome do Jogador</label>
                    <input class="form-control" type="text" name="jogador_nome" id="jogador_nome" value="{{$jogador->jogador_nome}}">

                    <label class="form-label" for="jogador_estado">Estado do Jogador</label>
                    <input class="form-control" type="text" name="jogador_estado" id="jogador_estado" value="{{$jogador->jogador_estado}}">
                </div>
